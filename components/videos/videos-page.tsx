            ...
            <CardContent className="grid gap-4 lg:grid-cols-3">
              ...
              <div className="rounded-lg border border-border/60 bg-card/60 p-4 transition-colors hover:bg-accent/30">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="rounded-md bg-muted px-2 py-0.5 text-xs font-mono font-semibold text-muted-foreground">{subtitleDelaySeconds.toFixed(1)}s</span>
                </div>
                <Slider
              ...
              <div className="rounded-lg border border-border/60 bg-card/60 p-4 transition-colors hover:bg-accent/30">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="rounded-md bg-muted px-2 py-0.5 text-xs font-mono font-semibold text-muted-foreground">{subtitleFontSize}px</span>
                </div>
                <Slider
